angular.module('app')
  ...
  return {
    ...
    link: function(scope, element, attrs) {
        ...
        scope.predicts = [{date: "22/05/2017 in Roland Garros", predictions: [{id: 1, player1: "Rafael NADAL", player2: "Novak DJOKOVIC", azurePlayer1: 45, twitterPlayer1: 65, firstSetPlayer1: 22},
